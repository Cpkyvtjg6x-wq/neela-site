 ...
 * Repli reduced-motion : bande simplement scrollable, sans pin ni 420vh.
 */
...
// Contenu du rail, partagé entre le mode animé et le repli.
const Intro = () => (
  <div className="w-[78vw] shrink-0 sm:w-[420px]">
    ...
    <p className="mt-5 max-w-sm text-[15px] leading-relaxed text-mut">
      Des créations conçues pour votre métier, conformes à la réglementation
      santé. Faites défiler →
    </p>
  </div>
);
...
export default function HorizontalAds() {
  ...
  // Repli mouvement réduit / appareil limité : bande scrollable, hauteur normale.
  if (!allowed) {
    return (
      <section className="bg-paper py-20">
        <div
          className="flex items-center gap-7 overflow-x-auto px-[6vw] pb-6"
