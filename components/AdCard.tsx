...
export default function AdCard({
  ...
  return (
    <div className="w-[320px] shrink-0 overflow-hidden rounded-2xl border border-line bg-white shadow-card">
      {/* En-tête */}
      ...
      {/* Média */}
      <div className="relative flex h-[200px] items-center justify-center overflow-hidden bg-gradient-to-br from-[#1e3a8a] via-accent to-[#5AA0FF]">
        <Wave />
        <div className="absolute bottom-4 left-4 font-display text-xl font-bold leading-tight text-white drop-shadow">
          {label}
        </div>
